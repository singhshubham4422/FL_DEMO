...
function Packet({ from, to, active, delay = 0 }) {
  return active ? (
    <motion.div
      className="absolute z-20 h-3 w-3 rounded-full bg-blue-500 shadow-[0_0_14px_rgba(59,130,246,0.95)]"
      initial={{ x: from.x, y: from.y, opacity: 0.4, scale: 0.8 }}
      animate={{ x: to.x, y: to.y, opacity: [0.4, 1, 0.4], scale: [0.85, 1.2, 0.85] }}
